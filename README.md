...
- **Species classifier (OSEA)** — `OSEAClassifier.mlpackage` (`OSEAClassifier.swift`). Architecture: **ResNet34** ([He et al., 2016](https://arxiv.org/abs/1512.03385)) with a 11000-way classification head (first 10964 classes are valid species). Trained on the OSEA bird-species dataset used by the upstream [SuperPicky](https://gitcode.com/Jamesphotography/SuperPicky) bird-ID pipeline. Upstream checkpoint: `model20240824.pth` (SuperPicky).
